...
void main() {
  testGoldens('PageTextBlock should be displayed correctly', (tester) async {
  ...
  testGoldens('PageTextBlock shimmer should be displayed correctly',
      (tester) async {
    final testWidget = Scaffold(
        appBar: AppBar(),
        body: ListView(children: const [
    ...
    await TestUtil.testWidgetInBothThemes(
        ...
        widgetId: 'page_text_block.shimmer');
  });
}
