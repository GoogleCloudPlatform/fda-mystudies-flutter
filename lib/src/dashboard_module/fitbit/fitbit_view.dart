...
import 'fitbit_tile.dart';
import 'recorded_value.dart';

class FitbitView extends StatelessWidget {
  const FitbitView({Key? key}) : super(key: key);
    ...
    return FutureLoadingPage.build(context,
      ...
      return SafeArea(
          child: ListView.builder(
              ...
              itemBuilder: (context, index) => FitbitTile(
                  charts[index].title,
